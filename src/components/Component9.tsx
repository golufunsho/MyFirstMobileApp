...
import { View, Text, TextInput, Button, TouchableWithoutFeedback, Platform, Switch, Alert } from 'react-native';
    ...
    <View>
        ...
        <View>
            ...
            <Slider minimumValue={0} maximumValue={10}
                onValueChange={(newValue: any)=>{setState({...state,museumItem: {...state.museumItem, viewerRating: newValue}})}}
                step={1}/>
        </View>
        <View>
